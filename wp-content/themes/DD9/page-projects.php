            ...
            <div class="block_container full_width clearfix">
                ...
                <div class="two_column">   
                  <h4 class="subheading breadcrumbs">Services</a></h4>     
                   <div class="block_content border_top">
                   	 ...
                   	 <p class="top_line">Below is a list of the graphic and web design services that we provide. Visit a page below to get in depth information about our design offerings.</p>
              ...
              <div class="content_right">   
                ...
                <?php if($projects): ?>
                	...
                	<?php if($wd_services): ?>
                      <ul class="filters">
                      <!-- Add the commenting between each <li> to remove the automatic inline block spacing: easier than doing yet another floated element -->
                        
                        <li><a href="#" data-filter=".all" class="instruction">Filter by:</a> </li><!--
  						--><li>
                        <a href="#" data-filter=".all">All</a></li><!--
  						--><li>
                          <a href="#" data-filter=".<?= $website_design->post_name ?>"><?= $website_design->post_title ?></a>
                        </li><!--
  						--><?php foreach($wd_services as $service): ?><li>
                          <a href="#" data-filter=".<?= $service->post_name ?>"><?= $service->post_title ?></a>
                        </li><!--
  						--><?php endforeach; ?><li>
                          <a href="#" data-filter=".<?= $graphic_design->post_name ?>"><?= $graphic_design->post_title ?></a>
                        </li><!--
  						--><?php foreach($gd_services as $service): ?><li>
                           <a href="#" data-filter=".<?= $service->post_name ?>"><?= $service->post_title ?></a>
                          </li><!--
  						--><?php endforeach; ?>
